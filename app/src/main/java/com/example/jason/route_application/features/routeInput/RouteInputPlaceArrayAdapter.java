...
/**
 * Created by Jason on 20-Feb-18.
 */

public class RouteInputPlaceArrayAdapter extends ArrayAdapter<RouteInputPlaceArrayAdapter.PlaceAutocomplete> implements Filterable {
     ...
     */
    public RouteInputPlaceArrayAdapter(Context context, int resource, LatLngBounds bounds, AutocompleteFilter filter) {
